...
SUPPORT_INTRO_DEVIN = (
    "🤖 <b>Чат с виртуальным ассистентом</b>\n\n"
    "Спрашивай про меню, бронирование, часы работы, как добраться. "
    "Ответ может занять до пары минут — ассистент думает медленно, но "
    "тщательно.\n\n"
    "Чтобы выйти, нажми кнопку <b>🚪 Выйти из чата</b> или отправь /cancel."
)
...
SUPPORT_TIMEOUT = (
    "⏳ Ассистент слишком долго думает. Попробуй переформулировать вопрос или "
    "выйди из чата командой /cancel."
)
